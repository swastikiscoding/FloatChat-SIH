...
export default function GoogleSignInButton() {
  ...
  return (
    <div className='w-full h-screen flex flex-col items-center bg-gray-900'>
      <div className="border-2 border-white/20 bg-black pr-20 pb-2  rounded-md shadow-xl shadow-cyan-500/40  mt-20 sm:mt-40">
        ...
        <div className="font-semibold text-2xl mt-4 text-center ml-19">Login</div>
        <div className=" ml-19 mb-10 text-lg">
        ...
        <div className="flex ml-35 gap-1">
